...
<form id="form1" runat="server" method="post">
    ...
    <script>
        ...
        function x() {
            ...
            if (!(($("#checkbox_google").is(":checked")) ||
                ($("#checkbox_yandex").is(":checked")) ||
                ($("#checkbox_bing").is(":checked")) ||
                ($("#checkbox_gigablast").is(":checked")) ||
                ($("#checkbox_HotBot").is(":checked")) ||
                ($("#checkbox_rambler").is(":checked")))) {
